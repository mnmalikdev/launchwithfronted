        ...
        <div>
          <div className="flex flex-row w-full justify-start gap-7 my-4">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-lg text-orangedark font-medium ">Search and offer your skills on the projects posted by visionaries</p>
            </div>
          ...
          <Modal isOpen={isOpen} onClose={toggleModal} bgColor="bg-bgbox">
            <div className="flex flex-col bg-bgbox justify-center">
              ...
              <div className=" flex flex-col justify-center items-center h-full">
                <img width={300} height={300} src="/icons/filter-search.svg" alt="filter-icon" className=" my-9" />
                <p className="text-2xl text-orangedark">Filters feature coming soon !</p>
              </div>
            </div>
          </Modal>
        </div>
